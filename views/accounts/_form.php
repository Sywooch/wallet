...
<div class="account-form">
    ...
    <?php if ($model->scenario == 'insert') : ?>
        ...
        <?= $form->field($model, 'currency_id')->dropDownList(\yii\helpers\ArrayHelper::merge(['' => ''], Currency::listAll())); ?>
    <?php else : ?>
    ...
    <?php if ($model->scenario == 'insert') : ?>
        <?= $form->field($model, 'parent_id')->dropDownList(Account::plainHierarcyForUser(Yii::$app->user->getId())); ?>
    <?php else: ?>
